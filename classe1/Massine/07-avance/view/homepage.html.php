                ...
                <div class="card h-100 border-0 shadow-sm hover-card">
                    <div class="card-header bg-white border-0 pb-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <span class="badge bg-primary">Article #<?=$i?></span>
                            <small class="text-muted">
                                <i class="bi bi-calendar me-1"></i><?=$item->getArticleDate()?>
                            </small>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">
                            <?=nl2br(html_entity_decode(substr($item->getArticleText(), 0, 200)))?>
                            <?php if(strlen($item->getArticleText()) > 200): ?>
                    ...
                    <div class="card-footer bg-white border-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="badge bg-light text-primary">
                                ...
                                <?= $item->getArticleVisibility() ? 'Publié' : 'Brouillon' ?>
                            </span>
                            <small class="text-muted">
